    ...
    <section class="categorie">
            ...
            <div class="categorie__list">
                ...
                <?php if (isset($_SESSION['user']) && ($_SESSION['user']['role'] === 'admin')){ ?>
                    <a href="/ctrl/prestation-add-display.php?lang=<?= $lang ?>" class="btn__admin_item" ><?= $language['prestation-add']?></a>
                <?php } ?>
                </div>
                    ...
                    <p class="categorie__libelle"><?= $categorie['libelle'] ?></p>
                        <?php foreach ($categorie['prestations'] as $p){ ?>
                            ...
                            <div class="prestation">
                                    ...
                                    <?php if (isset($_SESSION['user']) && ($_SESSION['user']['role'] === 'admin')){ ?>
                                        <div class="btn__admin">
                                            <a href="/ctrl/prestation-update-display.php?id=<?= $p['id'] ?>&lang=<?= $lang ?>" class="btn__admin_item"><?= $language['update_btn']?></a>
                                            <a href="/ctrl/prestation-delete.php?id=<?= $p['id'] ?>&lang=<?= $lang ?>" class="btn__admin_item"><?= $language['delete_btn']?></a>     
                                        </div>
                                    <?php } ?>
                            </div>
                        <?php } ?>
